<div class="row justify-content-center">
    <div class="col-lg-8">
        <div class="pulse-card">
            <h4 class="text-white mb-4"><i class="fa-solid fa-pen-to-square me-2 text-primary"></i>Edit Campaign & Metrics</h4>
            
            <form action="index.php?route=campaigns/edit/<?php echo $campaign_id; ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="campaign_code" id="campaign_code" class="form-control bg-dark border-secondary text-secondary font-monospace" value="<?php echo htmlspecialchars($campaign_code ?? ''); ?>" readonly disabled>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" step="0.01" name="spend" id="spend" class="form-control" value="<?php echo htmlspecialchars($spend ?? '0.00'); ?>">
                    </div>

                    <div class="col-md-4">
                        <label for="revenue_influenced" class="form-label text-secondary">Actual Revenue ($)</label>
                        <input type="number" step="0.01" name="revenue_influenced" id="revenue_influenced" class="form-control" value="<?php echo htmlspecialchars($revenue_influenced ?? '0.00'); ?>">
                    </div>
                        ...
                        <div class="p-3 rounded bg-dark border border-warning border-opacity-25 my-2">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?php if (!empty($proof_of_execution)): ?>
                                        <div class="mt-2 small">
                                            <span class="text-secondary me-2">Current Proof:</span>
                                            <a href="<?php echo htmlspecialchars($proof_of_execution); ?>" target="_blank" class="text-info text-decoration-none">
                                                <i class="fa-solid fa-paperclip me-1"></i>View Uploaded File
                                            </a>
                                        </div>
                                    <?php endif; ?>
                                </div>
