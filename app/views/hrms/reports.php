        ...
        <div class="col-lg-8 mb-4">
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    <div class="card border-0 shadow-sm p-3 h-100" style="background: var(--panel-dark); border: 1px solid var(--border-color) !important; border-radius: 12px;">
    ...
    buttons.forEach(function(btn) {
        btn.onclick = function() {
            ...
            if (type !== 'employees' && (from > today || to > today)) {
                alert('From Date and To Date cannot be in the future.');
                return;
            }
