<div class="row justify-content-center">
    <div class="col-lg-8">
        <div class="pulse-card">
            <h4 class="text-white mb-4"><i class="fa-solid fa-pen-to-square me-2 text-primary"></i>Edit Content Post</h4>
            
            <form action="index.php?route=posts/edit/<?php echo $post_id; ?>" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="post_code" id="post_code" class="form-control bg-dark border-secondary text-secondary font-monospace" value="<?php echo htmlspecialchars($post_code ?? ''); ?>" readonly disabled>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" name="title" id="title" 
                               ...
                               value="<?php echo htmlspecialchars($title_input ?? ''); ?>" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="datetime-local" name="published_at" id="published_at" class="form-control bg-dark border-secondary text-white" value="<?php echo htmlspecialchars($published_at ?? ''); ?>" required>
                    </div>

                    <!-- Media URL -->
                    <div class="col-md-12">
                        <label for="media_url" class="form-label text-secondary">Media Asset URL / Storage Link</label>
                        <input type="url" name="media_url" id="media_url" class="form-control" value="<?php echo htmlspecialchars($media_url ?? ''); ?>">
                    </div>

                    <!-- Post Body Content -->
                    <div class="col-md-12">
                        <label for="content" class="form-label text-secondary">Post Content / Caption</label>
                        <textarea name="content" id="content" rows="4" class="form-control"><?php echo htmlspecialchars($content ?? ''); ?></textarea>
                    </div>
