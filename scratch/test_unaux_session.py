...
login_url = "https://ags.raptor.unaux.com/public/index.php?route=auth/login"
...
for route in routes:
    u = f"https://ags.raptor.unaux.com/public/index.php?route={route}"
    try:
        r = opener.open(u)
        ...
        try:
            ...
            print("FULL ERROR BODY:", err_body[:500])
